...
def get_params():
    params = {
        # 'weight': 'yolov8n-obb.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'yolo11n.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'weight': 'F:\yolo+ir+rgb\YOLOv11_RGBT_master0619\YOLOv11_RGBT0\pre_weights\LLVIP/LLVIP_IF-yolo11n-e300-16-pretrained-.pt',
        ...
        'img_size':640, # 图像尺寸
        # 'channels':6, # 支持3,4和6通道
        # 'use_simotm': 'RGBRGB6C',  #  RGBRGB6C    RGB  RGBT
        'channels': 3,  # 支持3,4和6通道
        'use_simotm': 'RGB',  # RGBRGB6C    RGB  RGBT
...
if __name__ == '__main__':
    ...
    model(r"G:\datasets\yolo_LLVIP\yolo_LLVIP_align-im\image\train/010001.jpg",
          'heatmap/LLVIP/11n-pretrained/image/train/010001heatmap')